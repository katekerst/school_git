...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/08 18:55:12 by gbellege          #+#    #+#             */
/*   Updated: 2019/07/18 16:33:47 by gbellege         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				*ft_memcpy(void *dest, const void *source, size_t nb);
...
char				*ft_strchr(const char *source, int litera);
...
char				*ft_strjoin_full(char *s1, char *s2);
...
int					ft_word_pos_len_tosym(char *str, int qt, char sym);
